        ...
        <div className="relative flex flex-col w-full md:w-2/3 lg:w-2/3">
          <div className="flex-1">
            <img
              src={location}
              alt=""
              className="p-10 h-[400px] w-full md:h-[651px]"
            />
          </div>
          <div className="relative flex justify-center p-2 w-full -mt-[13%] md:-mt-[7%] md:ml-[34%] md:w-2/3">
            <iframe
              ...
              className="absolute bottom-0 w-2/3 md:w-2/3 lg:w-2/3"
            ></iframe>
          </div>
        </div>
